...
<library name="aurel">
<description>Hybrid RX-TX components for radiocontrols


data-sheet  on   http://www.aurel.it



design Claudio Menegazzi</description>
<packages>
<package name="AUREL_BC-NBK">
<description>Ricevitore RF 433,92 MHz</description>
...
<pad name="P$1" x="-20.32" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$2" x="-17.78" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$3" x="-15.24" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$4" x="-5.08" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$5" x="5.08" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$6" x="10.16" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$7" x="12.7" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<pad name="P$8" x="15.24" y="1.27" drill="0.4064" diameter="1.016" shape="long" rot="R90"/>
<text x="-6.35" y="2.54" size="1.27" layer="21">AUREL BC-NBK</text>
<text x="-17.78" y="2.54" size="1.27" layer="21">&gt;NAME</text>
</package>
</packages>
<symbols>
<symbol name="AUREL_BC-NBK">
...
<text x="-25.4" y="17.78" size="1.778" layer="94">&gt;NAME</text>
<text x="-25.4" y="-20.32" size="1.778" layer="94">AUREL BC-NBK</text>
<pin name="+5V" x="-30.48" y="15.24" visible="pin" length="middle"/>
<pin name="GND" x="-30.48" y="10.16" visible="pin" length="middle"/>
<pin name="INANT" x="-30.48" y="5.08" visible="pin" length="middle"/>
<pin name="GND2" x="-30.48" y="0" visible="pin" length="middle"/>
<pin name="GND3" x="-30.48" y="-5.08" visible="pin" length="middle"/>
<pin name="TEST" x="-30.48" y="-10.16" visible="pin" length="middle"/>
<pin name="OUT" x="5.08" y="0" visible="pin" length="middle" rot="R180"/>
<pin name="5V" x="-30.48" y="-15.24" visible="pin" length="middle"/>
</symbol>
</symbols>
<devicesets>
<deviceset name="AUREL_BC-NBK" prefix="IC" uservalue="yes">
<description>Ricevitore RF 433,92 MHz</description>
<gates>
<gate name="G$1" symbol="AUREL_BC-NBK" x="20.32" y="-2.54"/>
</gates>
<devices>
<device name="" package="AUREL_BC-NBK">
<connects>
...
<connect gate="G$1" pin="INANT" pad="P$3"/>
<connect gate="G$1" pin="OUT" pad="P$7"/>
<connect gate="G$1" pin="TEST" pad="P$6"/>
</connects>
<technologies>
<technology name=""/>
</technologies>
...
<part name="BT1" library="SparkFun-Batteries" library_urn="urn:adsk.eagle:library:508" deviceset="BATTERY" device="-9V" package3d_urn="urn:adsk.eagle:package:37219/1" value="5V"/>
<part name="IC2" library="aurel" deviceset="AUREL_BC-NBK" device=""/>
</parts>
<sheets>
<sheet>
<plain>
<text x="-27.94" y="10.16" size="2.413" layer="113">Designed by : 
 Team Alpha-10</text>
</plain>
<instances>
<instance part="IC1" gate="G$1" x="38.1" y="50.8" smashed="yes">
<attribute name="NAME" x="25.4" y="77.47" size="1.6764" layer="95"/>
</instance>
<instance part="BT1" gate="G$1" x="68.58" y="86.36" smashed="yes">
<attribute name="NAME" x="68.58" y="90.678" size="1.778" layer="95" font="vector" align="bottom-center"/>
<attribute name="VALUE" x="68.58" y="82.042" size="1.778" layer="96" font="vector" align="top-center"/>
</instance>
<instance part="IC2" gate="G$1" x="114.3" y="53.34" smashed="yes">
<attribute name="NAME" x="88.9" y="71.12" size="1.778" layer="94"/>
</instance>
</instances>
<busses>
</busses>
...
<pinref part="IC2" gate="G$1" pin="INANT"/>
